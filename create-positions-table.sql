...
INSERT INTO positions (name, description, department) VALUES
('Analista de Sistemas', 'Responsável pelo desenvolvimento e manutenção de sistemas', 'Tecnologia da Informação'),
('Gerente Geral', 'Gerenciamento geral da unidade', 'Administração'),
('Analista de Crédito', 'Análise e aprovação de operações de crédito', 'Crédito'),
('Caixa', 'Atendimento ao público e operações de caixa', 'Atendimento'),
('Coordenador', 'Coordenação de equipes e processos', 'Administração'),
('Assistente Administrativo', 'Apoio administrativo geral', 'Administração'),
('Analista Financeiro', 'Análise e controle financeiro', 'Financeiro')
