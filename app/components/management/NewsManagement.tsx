// Componente genérico de gerenciamento de notícias
// Unifica sector/subsector news management com parâmetros configuráveis
 ...
 */
export function NewsManagement<T extends BaseNews>({
  entityId,
  news,
  showDrafts,
  totalDraftNewsCount,
  ...
  const handleDeleteClick = (newsItem: T) => {
    deleteModal.openDeleteModal(newsItem, newsItem.title);
  };

  const handleDeleteNews = async (newsItem: T) => {
    try {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              {/* Error display - only for admin version without alerts */}
              {!config.useAlerts && saveError && (
