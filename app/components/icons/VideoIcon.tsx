...
export const VideoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    ...
    <path 
      fillRule="evenodd" 
      clipRule="evenodd" 
      d="M9.5 15.4641L15.5 12L9.5 8.53594L9.5 15.4641ZM16.25 13.2991C17.25 12.7217 17.25 11.2784 16.25 10.701L10.25 7.2369C9.25 6.65955 8 7.38124 8 8.53594V15.4641C8 16.6188 9.25 17.3405 10.25 16.7632L16.25 13.2991Z" 
      fill="currentColor"
    />
  </svg>
); 