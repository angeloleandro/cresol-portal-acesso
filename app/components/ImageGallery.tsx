    ...
    <section className="card">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-4">
        {showImages.map((img) => {
          ...
          return (
            <div key={img.id} className="bg-white rounded-md border border-gray-200/60 cursor-pointer hover:border-gray-200 transition-colors duration-150 overflow-hidden group" onClick={() => handleOpenModal(img)}>
