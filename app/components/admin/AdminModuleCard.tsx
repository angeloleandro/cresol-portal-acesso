...
export default function AdminModuleCard({ 
  ...
  return (
    ...
    >
      <div className="icon-container-modern mr-4 flex-shrink-0 group-hover:scale-105 transition-transform duration-200">
      ...
      <Icon 
        name="arrow-left" 
        className="h-4 w-4 text-muted group-hover:text-primary group-hover:translate-x-1 flex-shrink-0 mt-1 rotate-180 transition-all duration-200" 
      />
    </Link>
  );
}