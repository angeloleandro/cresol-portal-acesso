...
interface SubsectorVideosProps {
  subsectorId: string;
  limit?: number;
}

export default function SubsectorVideos({ subsectorId, limit = 4 }: SubsectorVideosProps) {
  ...
  return (
    <section 
      ...
      aria-labelledby="subsector-videos-heading"
    >
      <div className="p-6 border-b border-cresol-gray-light">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h2 id="subsector-videos-heading" className="text-xl font-semibold text-cresol-gray-dark">
              Vídeos
            </h2>
          </div>
          {videos.length > 0 && (
            <Link 
              href={`/subsetores/${subsectorId}/videos`}
