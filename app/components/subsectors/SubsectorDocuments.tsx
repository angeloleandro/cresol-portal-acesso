...
interface SubsectorDocumentsProps {
  subsectorId: string;
  compact?: boolean;
  limit?: number;
}

export default function SubsectorDocuments({ subsectorId, compact = false, limit = 3 }: SubsectorDocumentsProps) {
  ...
  return (
    <section 
      ...
      aria-labelledby="subsector-documents-heading"
    >
      <div className="p-6 border-b border-cresol-gray-light">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h2 id="subsector-documents-heading" className="text-xl font-semibold text-cresol-gray-dark">
              Documentos
            </h2>
          </div>
          {documents.length > 0 && (
            <Link 
              href={`/subsetores/${subsectorId}/documentos`}
