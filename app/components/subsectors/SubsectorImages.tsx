...
interface SubsectorImagesProps {
  subsectorId: string;
  limit?: number;
}

export default function SubsectorImages({ subsectorId, limit = 6 }: SubsectorImagesProps) {
      ...
      try {
        ...
        if (process.env.NODE_ENV === 'development') {
          processedImages.forEach(img => 
            debugImageUrl(img.image_url, `Subsector Image: ${img.title}`)
          );
        }
  ...
  return (
    <section 
      ...
      aria-labelledby="subsector-images-heading"
    >
      <div className="p-6 border-b border-cresol-gray-light">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h2 id="subsector-images-heading" className="text-xl font-semibold text-cresol-gray-dark">
              Imagens
            </h2>
          </div>
          {images.length > 0 && (
            <Link 
              href={`/subsetores/${subsectorId}/imagens`}
