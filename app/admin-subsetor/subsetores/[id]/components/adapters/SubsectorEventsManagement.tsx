// Adapter for EventsManagement component to work with subsector data
// This component wraps the sector EventsManagement component and adapts the API calls

import React, { useState } from 'react';
import { SectorEvent } from '@/app/admin/sectors/[id]/types/sector.types';
import { formatEventPeriod, formatForDateTimeInput } from '@/app/admin/sectors/[id]/utils/dateFormatters';
...
export function SubsectorEventsManagement({
  ...
  const handleDeleteEvent = async (id: string) => {
    ...
    try {
      // ADAPTED FOR SUBSECTOR: Use subsector_events type
      const response = await fetch(`/api/admin/sector-content?type=subsector_events&id=${id}`, {
        method: 'DELETE'
      });
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-500">
                    <span className="flex items-center">
                      ...
                      {item.location || 'Local não especificado'}
                    </span>
                    <span className="flex items-center">
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
