...
import type { SubsectorTeamMember, Profile } from '@/types/team';
...
export function TeamManagement({ subsectorId }: TeamManagementProps) {
  ...
  const [editingMember, setEditingMember] = useState<SubsectorTeamMember | null>(null);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-semibold text-gray-800">Gerenciar Equipe do Subsetor</h2>
        <button
      ...
      {adminMembers.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-lg font-medium text-gray-800 mb-4 flex items-center gap-2">
            <Icon name="user-group" className="h-5 w-5 text-green-600" />
            Administradores do Subsetor
          </h3>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-secondary text-white rounded-md hover:bg-secondary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Adicionar
              </button>
            </div>
